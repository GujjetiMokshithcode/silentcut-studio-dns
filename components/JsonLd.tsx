...
export function JsonLd({ type }: JsonLdProps) {
    const schemas = {
        SoftwareApplication: {
            ...
            description: 'Remove pauses from ElevenLabs and AI voice audio instantly. Fix the pause problems that plague synthetic voices with one-click processing.',
            url: siteUrl,
            ...
            featureList: [
                'Remove pauses from ElevenLabs audio',
                'Fix AI voice pacing issues',
                'Works with any synthetic voice (Google TTS, Azure, Murf)',
