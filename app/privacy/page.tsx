            ...
            <div className="container mx-auto px-4 py-20 max-w-4xl">
                ...
                <div className="prose prose-invert max-w-none space-y-12">
                    ...
                    <section>
                        ...
                        <p className="text-white/70 leading-relaxed">
                            If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:silentcut@silentcut.studio" className="px-2 py-1 rounded bg-primary/10 text-primary hover:bg-primary/20 transition-colors font-medium ml-1">silentcut@silentcut.studio</a>
                        </p>
                    </section>
                </div>
            </div>
